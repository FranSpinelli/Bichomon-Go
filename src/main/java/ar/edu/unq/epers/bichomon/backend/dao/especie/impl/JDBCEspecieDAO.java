...
<<<<<<< Updated upstream:src/main/java/ar/edu/unq/epers/bichomon/backend/dao/impl/JDBCEspecieDAO.java
...
=======
            return DriverManager.getConnection("jdbc:mysql://localhost:3306/epers_persistiendoConEstilo_jdbc?user=root&password=root	&serverTimezone=UTC");
>>>>>>> Stashed changes:src/main/java/ar/edu/unq/epers/bichomon/backend/dao/especie/impl/JDBCEspecieDAO.java
        } catch (SQLException e) {
